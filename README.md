...
I architect and direct AI coding agents to design, build, and ship real, deployed software — solo, end to end. The focus is the domain I work in: tools that help banks and finance professionals read markets, manage risk, and stay ahead of policy.

---

## Products

### [The Brief](https://thebrief.clauding-lab.com)
<a href="https://thebrief.clauding-lab.com"><img src="https://raw.githubusercontent.com/clauding-lab/clauding-lab/main/assets/hero-the-brief.svg" alt="The Brief" width="100%"></a>

**Problem** — Bankers start the day with the market-moving picture scattered across Bangladesh Bank, the DSE, news, and terminals; there's no single trustworthy read.
...
**Problem** — Treasury & ALCO teams have no single, at-a-glance view of the yield curve, money-market liquidity, and the macro signals they manage the balance sheet against.
...
*Also in the lab (private): SME-performance intelligence and bank-statement intelligence.*

---

## How it's built

Every product is **vibe-coded** — I direct AI coding agents (Claude Code) rather than hand-writing code. Each repo runs a small governance system (`AGENTS.md` · `VISION.md` · `AGENT_LEARNINGS.md`) so the agents ship consistently and learn from mistakes. Several run in production: *The Brief* researches, writes, and publishes itself every morning, unattended.
